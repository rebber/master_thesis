...
#Try out -count option for coverage calculation
...
bamFiles_Path <- paste(paste(path_main,bamFiles[1:2],sep=""),collapse=" ")
output_dir <- "/home/rebecka.bergstrom/cnvkit/BREASTv6_all/batchResultsTestCounts/"
setwd(output_dir)
ref_name <- "/home/rebecka.bergstrom/cnvkit/BREASTv6_all/batchResults/referenceFlatPanelV1.cnn"

#run the tumors 
systemCommand <- paste("cnvkit.py batch ", bamFiles_Path, " -r ", ref_name, " -c --output-dir ", output_dir,sep="")
