...
#readCounts <- binReadCounts(bins1ksr50normbl,bamfiles=mybamfiles)
#saveRDS(readCounts,"readCounts_wgs.rds") #flyttad till breastv7_QDNAseq_reb/QDNAseq_adj_alltargbins/
#rm(bins1ksr50normbl)
readCounts <- readRDS("breastv7_QDNAseq_reb/QDNAseq_adj_alltargbins/readCounts_wgs.rds")
##################################################
#Change blaccklist=TRUE? Prob not
#################################################
...
#remove the QDNAseq objects for wgs
...
#saveRDS(readCounts,"readCounts_panel.rds") 
#rm(bins1ksr50ntbl)
readCounts <- readRDS("breastv7_QDNAseq_reb/QDNAseq_adj_alltargbins/readCounts_panel.rds")
##################################################
#Current filtration: Use all bins overlapping w/ target, no others
#################################################
readCountsFiltered <- applyFilters(readCounts, residual = TRUE, blacklist = TRUE)
#here change use to true for all bins somehow overlapping with a target. 
