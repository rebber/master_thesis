#Run CNVkit for MSI1 tumors, use 5 normals as reference
#Created by Rebecka Bergström on 2016-03-15

path_MSI <- "/home/Crisp/clinseq/MSI-PILOT/"
bamFiles_Path <- paste(path_MSI,"*/panel/*T-TD1-CS1-capped.bam",sep="")
ref_samples <- c("ref1B","ref2B","ref3B","ref4B","ref5B")
#exchange "ref1" etc for actual sample IDs
output_dir <- "/home/rebecka.bergstrom/cnvkit/MSI-PILOT/batchResultsRef5/"
setwd(output_dir)
