#Plot comparison of the segments and bins from CNVkit for panel data with tumor reference (not blood) and from QDNAseq for wgs data, for Bv7 samples with homoz. deletion of PTEN

path_CNVkit <- "/home/rebecka.bergstrom/cnvkit/BREASTv7_PTEN_del/homozDelPTEN/tumRef/full_tumors/"
...
for (i in 1:length(files_cnr)) {
  ...
  title_panel <- paste("BREASTv7 log2 copy number chr 10 ",basename(file_path_sans_ext(files_cnr[i])),".cnvkit (tumor ref)",sep="")
  title_panel_zoomIn <- "zoom in on PTEN, panel"
  filename=paste("Bv7_PTENdel_compWgsPaneltumref_",basename(file_path_sans_ext(file_path_sans_ext(gsub("_wgs","",files_wgs[i])))),".pdf",sep="")
...
saveRDS(test1_panel_collection,paste(path_CNVkit, "Rplots/segmentPlotsComp/wilcoxontest/5x2Mbctrl/","test1_panelT.rds",sep=""))
saveRDS(test2_panel_collection,paste(path_CNVkit, "Rplots/segmentPlotsComp/wilcoxontest/5x2Mbctrl/","test2_panelT.rds",sep=""))
saveRDS(PTENbins_panel_collection,paste(path_CNVkit, "Rplots/segmentPlotsComp/wilcoxontest/5x2Mbctrl/","PTENbins_panelT.rds",sep=""))
saveRDS(surrPTEN1_panel_collection,paste(path_CNVkit, "Rplots/segmentPlotsComp/wilcoxontest/5x2Mbctrl/","surrPTEN1_panelT.rds",sep=""))
saveRDS(surrPTEN2_panel_collection,paste(path_CNVkit, "Rplots/segmentPlotsComp/wilcoxontest/5x2Mbctrl/","surrPTEN2_panelT.rds",sep=""))
...
saveRDS(test1_wgs_collection,paste(path_CNVkit, "Rplots/segmentPlotsComp/wilcoxontest/5x2Mbctrl/","test1_wgs",".rds",sep=""))
saveRDS(test2_wgs_collection,paste(path_CNVkit, "Rplots/segmentPlotsComp/wilcoxontest/5x2Mbctrl/","test2_wgs",".rds",sep=""))
saveRDS(PTENbins_wgs_collection,paste(path_CNVkit, "Rplots/segmentPlotsComp/wilcoxontest/5x2Mbctrl/","PTENbins_wgs",".rds",sep=""))
saveRDS(surrPTEN1_wgs_collection,paste(path_CNVkit, "Rplots/segmentPlotsComp/wilcoxontest/5x2Mbctrl/","surrPTEN1_wgs",".rds",sep=""))
saveRDS(surrPTEN2_wgs_collection,paste(path_CNVkit, "Rplots/segmentPlotsComp/wilcoxontest/5x2Mbctrl/","surrPTEN2_wgs",".rds",sep=""))
