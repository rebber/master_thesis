#Compare MAPD vs mrpb for 2 kinds of normalizations: ref of 50 norms and ref of 50 norms + additinonal pca-adjustment from linear fitted function
#Created by Rebecka Bergström on 2016-05-31

path_CNVkit <- "/home/rebecka.bergstrom/cnvkit/HOPKINS/hopkins_1000G/MAPDcomp/"

mrpb_func_adj <- read.table(paste(path_CNVkit,"mrpb_ref50norm_func_adj.txt",sep=""),header=TRUE,as.is=TRUE)
mrpb_ref50norm <- read.table(paste(path_CNVkit,"mrpb_ref50norm.txt",sep=""),header=TRUE,as.is=TRUE)

MAPD_func_adj <- read.table(paste(path_CNVkit,"MAPD_ref50norm_func_adj.txt",sep=""),header=TRUE,as.is=TRUE)
MAPD_ref50norm <- read.table(paste(path_CNVkit,"MAPD_ref50norm.txt",sep=""),header=TRUE,as.is=TRUE)

#order due to mrpb
oT_func_adj <- order(mrpb_func_adj[,1])
oT_50norm <- order(mrpb_ref50norm[,1])
oAT_func_adj <- order(mrpb_func_adj[,2])
oAT_50norm <- order(mrpb_ref50norm[,2])
...
points(as.double(mrpb_ref50norm[,1])[oT_50norm],MAPD_ref50norm[,1][oT_50norm],col=cols[1],lty=1,type="l",lwd=2)
points(as.double(mrpb_ref50norm[,2])[oAT_50norm],MAPD_ref50norm[,2][oAT_50norm],col=cols[1],lty=3,type="l",lwd=2)
points(as.double(mrpb_func_adj[,1])[oT_func_adj],MAPD_func_adj[,1][oT_func_adj],col=cols[2],lty=1,type="l",lwd=2)
points(as.double(mrpb_func_adj[,2])[oAT_func_adj],MAPD_func_adj[,2][oAT_func_adj],col=cols[2],lty=3,type="l",lwd=2)
legend_text <- c("reference type:","50 normals", "50 norm + pca funct cor"," ","bin type:", "target", "antitarget"," ", "1 x stochastic process", "2 x stochastic process")
legend("topright",legend_text, col=c(NA,cols[1:2],NA,NA,1,1,NA,1,1),pch=c(NA,rep(16,2),rep(NA,7)),lty=c(rep(NA,5),1,3,NA,1,2),lwd=c(rep(NA,5),2,2,NA,1,1))
...
points(as.double(mrpb_ref50norm[,2])[oAT_50norm],MAPD_ref50norm[,2][oAT_50norm],col=cols[1],lty=3,type="l",lwd=2)
points(as.double(mrpb_func_adj[,2])[oAT_func_adj],MAPD_func_adj[,2][oAT_func_adj],col=cols[2],lty=3,type="l",lwd=2)
legend_text <- c("reference type:","50 normals", "50 norm + pca funct cor", " ", "1 x stochastic process", "2 x stochastic process")
legend("topright",legend_text, col=c(NA,cols[1:2],NA,1,1),lty=c(NA,rep(3,2),NA,1,2),lwd=c(NA,rep(2,2),NA,1,1))
...
plot(reads,mapd,xlab='median #reads per bin',ylab='median absolute pairwise difference (log2 CN ratio)',type='l',main='targets & antitargets',log="x",ylim=c(0,1),xlim=c(1,1400),cex.main=1.5,cex.axis=1.5,cex.lab=1.5)
points(reads, mapd*sqrt(2),type="l",lty=2)
cols <- c("red","darkgreen")
lines(lowess(as.double(mrpb_ref50norm[,1])[oT_50norm],MAPD_ref50norm[,1][oT_50norm],f=1/4),col=cols[1],lty=1,type="l",lwd=2)
lines(lowess(as.double(mrpb_ref50norm[,2])[oAT_50norm],MAPD_ref50norm[,2][oAT_50norm],f=1/4),col=cols[1],lty=3,type="l",lwd=2)
lines(lowess(as.double(mrpb_func_adj[,1])[oT_func_adj],MAPD_func_adj[,1][oT_func_adj],f=1/4),col=cols[2],lty=1,type="l",lwd=2)
lines(lowess(as.double(mrpb_func_adj[,2])[oAT_func_adj],MAPD_func_adj[,2][oAT_func_adj],f=1/4),col=cols[2],lty=3,type="l",lwd=2)
legend_text <- c("reference type:","50 normals", "50 norm + pca funct cor"," ","bin type:", "target", "antitarget"," ", "1 x stochastic process", "2 x stochastic process")
legend("topright",legend_text, col=c(NA,cols[1:2],NA,NA,1,1,NA,1,1),pch=c(NA,rep(16,2),rep(NA,7)),lty=c(rep(NA,5),1,3,NA,1,2),lwd=c(rep(NA,5),2,2,NA,1,1))
dev.off()
...
lines(lowess(as.double(mrpb_refFlat_nonadj[,1])[oT_func_adj],MAPD_refFlat_nonadj[,1][oT_func_adj],f=1/4),col=cols[4],lty=1,type="l",lwd=2)
lines(lowess(as.double(mrpb_refFlat_nonadj[,2])[oAT_func_adj],MAPD_refFlat_nonadj[,2][oAT_func_adj],f=1/4),col=cols[4],lty=3,type="l",lwd=2)
lines(lowess(as.double(mrpb_refFlat_adj[,1])[oT_func_adj],MAPD_refFlat_adj[,1][oT_func_adj],f=1/4),col=cols[5],lty=1,type="l",lwd=2)
lines(lowess(as.double(mrpb_refFlat_adj[,2])[oAT_func_adj],MAPD_refFlat_adj[,2][oAT_func_adj],f=1/4),col=cols[5],lty=3,type="l",lwd=2)
lines(lowess(as.double(mrpb_func_adj[,1])[oT_func_adj],MAPD_func_adj[,1][oT_func_adj],f=1/4),col=cols[2],lty=1,type="l",lwd=2)
lines(lowess(as.double(mrpb_func_adj[,2])[oAT_func_adj],MAPD_func_adj[,2][oAT_func_adj],f=1/4),col=cols[2],lty=3,type="l",lwd=2)
...
points(reads, mapd*sqrt(2),type="l",lty=2)
lines(as.double(mrpb_ref50norm[which(assigned_clust==1),1])[oT_50norm],MAPD_ref50norm[which(assigned_clust==1),1][oT_50norm],col=cols[1],lty=1)
...
lines(as.double(mrpb_refFlat_nonadj[which(assigned_clust==1),1])[oT_func_adj],MAPD_refFlat_nonadj[which(assigned_clust==1),1][oT_func_adj],col=cols[4],lty=1)
lines(as.double(mrpb_refFlat_adj[which(assigned_clust==1),1])[oT_func_adj],MAPD_refFlat_adj[which(assigned_clust==1),1][oT_func_adj],col=cols[5],lty=1)
lines(as.double(mrpb_func_adj[which(assigned_clust==1),1])[oT_func_adj],MAPD_func_adj[which(assigned_clust==1),1][oT_func_adj],col=cols[2],lty=1)
...
points(reads, mapd*sqrt(2),type="l",lty=2)
lines(as.double(mrpb_ref50norm[which(assigned_clust==2),1])[oT_50norm],MAPD_ref50norm[which(assigned_clust==2),1][oT_50norm],col=cols[1],lty=1)
...
lines(as.double(mrpb_refFlat_nonadj[which(assigned_clust==2),1])[oT_func_adj],MAPD_refFlat_nonadj[which(assigned_clust==2),1][oT_func_adj],col=cols[4],lty=1)
lines(as.double(mrpb_refFlat_adj[which(assigned_clust==2),1])[oT_func_adj],MAPD_refFlat_adj[which(assigned_clust==2),1][oT_func_adj],col=cols[5],lty=1)
lines(as.double(mrpb_func_adj[which(assigned_clust==2),1])[oT_func_adj],MAPD_func_adj[which(assigned_clust==2),1][oT_func_adj],col=cols[2],lty=1)
...
points(reads, mapd*sqrt(2),type="l",lty=2)
lines(as.double(mrpb_ref50norm[which(assigned_clust==3),1])[oT_50norm],MAPD_ref50norm[which(assigned_clust==3),1][oT_50norm],col=cols[1],lty=1)
...
lines(as.double(mrpb_refFlat_nonadj[which(assigned_clust==3),1])[oT_func_adj],MAPD_refFlat_nonadj[which(assigned_clust==3),1][oT_func_adj],col=cols[4],lty=1)
lines(as.double(mrpb_refFlat_adj[which(assigned_clust==3),1])[oT_func_adj],MAPD_refFlat_adj[which(assigned_clust==3),1][oT_func_adj],col=cols[5],lty=1)
lines(as.double(mrpb_func_adj[which(assigned_clust==3),1])[oT_func_adj],MAPD_func_adj[which(assigned_clust==3),1][oT_func_adj],col=cols[2],lty=1)
legend_text <- c("5 normals", "327 normals", "10 tumors", "GC cor only", "GC cor only + pca clust adj", "GC cor only + pca funct adj")
...
points(reads, mapd*sqrt(2),type="l",lty=2)
lines(as.double(mrpb_ref50norm[which(assigned_clust==0),1])[oT_50norm],MAPD_ref50norm[which(assigned_clust==0),1][oT_50norm],col=cols[1],lty=1)
...
lines(as.double(mrpb_refFlat_nonadj[which(assigned_clust==0),1])[oT_func_adj],MAPD_refFlat_nonadj[which(assigned_clust==0),1][oT_func_adj],col=cols[4],lty=1)
lines(as.double(mrpb_refFlat_adj[which(assigned_clust==0),1])[oT_func_adj],MAPD_refFlat_adj[which(assigned_clust==0),1][oT_func_adj],col=cols[5],lty=1)
lines(as.double(mrpb_func_adj[which(assigned_clust==0),1])[oT_func_adj],MAPD_func_adj[which(assigned_clust==0),1][oT_func_adj],col=cols[2],lty=1)
legend_text <- c("5 normals", "327 normals", "10 tumors", "GC cor only", "GC cor only + pca clust adj", "GC cor only + pca funct adj")
legend("topright",legend_text, col=cols,lty=rep(3,6))
#antitargets
...
points(reads, mapd*sqrt(2),type="l",lty=2)
lines(as.double(mrpb_ref50norm[which(assigned_clust==1),2])[oAT_50norm],MAPD_ref50norm[which(assigned_clust==1),2][oAT_50norm],col=cols[1],lty=3)
...
lines(as.double(mrpb_refFlat_nonadj[which(assigned_clust==1),2])[oAT_func_adj],MAPD_refFlat_nonadj[which(assigned_clust==1),2][oAT_func_adj],col=cols[4],lty=3)
lines(as.double(mrpb_refFlat_adj[which(assigned_clust==1),2])[oAT_func_adj],MAPD_refFlat_adj[which(assigned_clust==1),2][oAT_func_adj],col=cols[5],lty=3)
lines(as.double(mrpb_func_adj[which(assigned_clust==1),2])[oAT_func_adj],MAPD_func_adj[which(assigned_clust==1),2][oAT_func_adj],col=cols[2],lty=3)
legend_text <- c("5 normals", "327 normals", "10 tumors", "GC cor only", "GC cor only + pca clust adj", "GC cor only + pca funct adj")
...
points(reads, mapd*sqrt(2),type="l",lty=2)
lines(as.double(mrpb_ref50norm[which(assigned_clust==2),2])[oAT_50norm],MAPD_ref50norm[which(assigned_clust==2),2][oAT_50norm],col=cols[1],lty=3)
...
lines(as.double(mrpb_refFlat_nonadj[which(assigned_clust==2),2])[oAT_func_adj],MAPD_refFlat_nonadj[which(assigned_clust==2),2][oAT_func_adj],col=cols[4],lty=3)
lines(as.double(mrpb_refFlat_adj[which(assigned_clust==2),2])[oAT_func_adj],MAPD_refFlat_adj[which(assigned_clust==2),2][oAT_func_adj],col=cols[5],lty=3)
lines(as.double(mrpb_func_adj[which(assigned_clust==2),2])[oAT_func_adj],MAPD_func_adj[which(assigned_clust==2),2][oAT_func_adj],col=cols[2],lty=3)
legend_text <- c("5 normals", "327 normals", "10 tumors", "GC cor only", "GC cor only + pca clust adj", "GC cor only + pca funct adj")
legend("topright",legend_text, col=cols,lty=rep(4,6))
...
points(reads, mapd*sqrt(2),type="l",lty=2)
lines(as.double(mrpb_ref50norm[which(assigned_clust==3),2])[oAT_50norm],MAPD_ref50norm[which(assigned_clust==3),2][oAT_50norm],col=cols[1],lty=3)
...
lines(as.double(mrpb_refFlat_nonadj[which(assigned_clust==3),2])[oAT_func_adj],MAPD_refFlat_nonadj[which(assigned_clust==3),2][oAT_func_adj],col=cols[4],lty=3)
lines(as.double(mrpb_refFlat_adj[which(assigned_clust==3),2])[oAT_func_adj],MAPD_refFlat_adj[which(assigned_clust==3),2][oAT_func_adj],col=cols[5],lty=3)
lines(as.double(mrpb_func_adj[which(assigned_clust==3),2])[oAT_func_adj],MAPD_func_adj[which(assigned_clust==3),2][oAT_func_adj],col=cols[2],lty=3)
legend_text <- c("5 normals", "327 normals", "10 tumors", "GC cor only", "GC cor only + pca clust adj", "GC cor only + pca funct adj")
legend("topright",legend_text, col=cols,lty=rep(4,6))
...
points(reads, mapd*sqrt(2),type="l",lty=2)
lines(as.double(mrpb_ref50norm[which(assigned_clust==0),2])[oAT_50norm],MAPD_ref50norm[which(assigned_clust==0),2][oAT_50norm],col=cols[1],lty=3)
...
lines(as.double(mrpb_refFlat_nonadj[which(assigned_clust==0),2])[oAT_func_adj],MAPD_refFlat_nonadj[which(assigned_clust==0),2][oAT_func_adj],col=cols[4],lty=3)
lines(as.double(mrpb_refFlat_adj[which(assigned_clust==0),2])[oAT_func_adj],MAPD_refFlat_adj[which(assigned_clust==0),2][oAT_func_adj],col=cols[5],lty=3)
lines(as.double(mrpb_func_adj[which(assigned_clust==0),2])[oAT_func_adj],MAPD_func_adj[which(assigned_clust==0),2][oAT_func_adj],col=cols[2],lty=3)
legend_text <- c("5 normals", "327 normals", "10 tumors", "GC cor only", "GC cor only + pca clust adj", "GC cor only + pca funct adj")
legend("topright",legend_text, col=cols,lty=rep(4,6))
dev.off()